...
export const CFG = {
  ...
  player: {
    ...
    eatRadius: 1.16,       // множитель касания пищи
    magnetBase: 104,       // базовый радиус притяжения пищи
    eatHeal: 0.6,          // ХП за съеденную биомассу
    dnaPerBiomass: 0.16,
    growth: [24, 44, 70, 100, 138, 184, 236, 296, 364], // биомасса на переход к следующему уровню
    maxTier: 10,
    genomeSlotBase: 6,
