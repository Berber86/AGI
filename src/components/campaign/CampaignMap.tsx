...
import { Swords, ShieldAlert, Hammer, Tent, Skull, CheckCircle2 } from 'lucide-react';
...
export const CampaignMap: React.FC = () => {
  const { campaign, startBattle, handleRestNode, handleWorkshopNode } = useGameStore();
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="text-[10px] text-slate-400">
                            {node.type === 'boss' ? 'Босс' : node.type === 'elite' ? 'Элита' : node.type === 'rest' ? 'Привал' : node.type === 'workshop' ? 'Кузня' : 'Битва'}
                          </span>
