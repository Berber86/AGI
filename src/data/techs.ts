...
export const TECH_NODES: TechNode[] = [
  ...
  {
    id: 'hunting_traps',
    name: 'Охотничьи Капканы',
    era: 1,
    branch: 'warfare',
    cost: 55,
    prerequisites: ['phalanx_drills'],
    icons: { war: 1, agri: 1 },
    description: 'Пружинные ловушки для сдерживания диких автоматонов.',
    bonusEffectText: '+5% к шансу крита дуэлянта',
    effects: { statBonuses: { critChance: 0.05 } },
  },
  {
    id: 'watermill_power',
    name: 'Водяное Колесо',
  ...
  },
  {
    ...
    branch: 'warfare',
    cost: 170,
    prerequisites: ['hunting_traps', 'rifled_barrels'],
    icons: { war: 2, agri: 1 },
    description: 'Обходные маневры и атаки из укрытий на пересеченной местности.',
    bonusEffectText: '+5 к Скорости и +10% к Уклонению',
    effects: { statBonuses: { speed: 5 } },
  },
  {
  ...
  {
    id: 'sniper_doctrine',
    name: 'Доктрина Точечного Выстрела',
    era: 3,
    branch: 'warfare',
    cost: 430,
    prerequisites: ['skirmish_tactics', 'heavy_artillery_chassis'],
    icons: { war: 3, craft: 1 },
    description: 'Оптимизация прицеливания в слабые звенья брони титанов.',
    bonusEffectText: '+15% к шансу крита и игнорирование 15% брони',
    effects: { statBonuses: { critChance: 0.15 } },
  },
  {
    id: 'toxic_phlogiston',
    ...
    bonusEffectText: '+15 к Атаке; атаки поджигают цели',
  ...
  {
    id: 'nanite_cogs',
    name: 'Микромеханический Рой',
    era: 4,
    branch: 'industry',
    cost: 900,
    prerequisites: ['perpetual_governor'],
    icons: { craft: 3, lore: 3 },
    description: 'Самособирающиеся зубчатые передачи микронного размера.',
    bonusEffectText: '+10 к Защите и +100 к Макс. HP',
    effects: { statBonuses: { defense: 10, maxHp: 100 } },
  },
  {
