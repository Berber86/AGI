...
export const FX_PROFILE = {
  ...
  // --- командование: очки раунда, которыми оплачиваются атакующие и блокирующие ---
  // Агрессия хочет больше атакующих и дешёвую команду, контроль — задушить
  // чужой бюджет и держать линию бесплатной Муштрой.
  banner:         [2.5, 1.5, 2.0, 2.0],
  panic:          [1.0, 1.5, 2.0, 2.8],
  staff:          [2.5, 2.8, 2.0, 1.2],
  drill:          [0.5, 1.5, 2.5, 2.8],
